    ...
    <div className="App">
      ...
      <header id="header" className="d-flex flex-column justify-content-center">
        ...
        <nav className="nav-menu">
          <ul>
            <li className="active"><a href="#profile"><FaHome /> <span>Accueil</span></a></li>
            <li><a href="#about"><FaUser /> <span>Profile</span></a></li>
            <li><a href="#skills"><FaCode /> <span>Compétences</span></a></li>
            <li><a href="#resume"><FaFile /> <span>Parcours</span></a></li>
            <li><a href="#portfolio"><FaLaptopCode /> <span>Portfolio</span></a></li>
            <li><a href="#contact"><FaEnvelope /> <span>Contactez-moi</span></a></li>
          </ul>
        </nav>
